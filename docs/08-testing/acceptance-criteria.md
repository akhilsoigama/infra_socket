...
| AC-07 | Isolation Forest scores normal data below threshold | AI test AI-01 | _Pending_ |
...
| AC-10 | Dashboard displays live waveform, spectrum, and anomaly score | Integration test INT-01 | _Pending_ |
