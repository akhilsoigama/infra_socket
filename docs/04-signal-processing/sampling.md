...
## Sampling Rate Selection for Infrasense

| Parameter | Value | Reasoning |
|---|---|---|
| Maximum signal frequency | 20 Hz | Upper bound of infrasound range |
| Nyquist minimum sampling rate | 40 Hz | 2 × 20 Hz |
| Proposed sampling rate | **50 Hz** | Provides 25% margin above Nyquist |
| Alternative higher rate | 100 Hz | More margin, useful if higher-frequency noise analysis is desired |
...
- Standard rate used in many data acquisition systems
