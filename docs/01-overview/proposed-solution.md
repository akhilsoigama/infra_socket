...
Infrasense addresses the problem of accessible infrasound monitoring by combining custom sensor hardware, digital signal processing, and AI-based anomaly detection into a single integrated prototype system.
