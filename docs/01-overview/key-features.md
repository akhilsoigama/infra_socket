...
Wind-induced pressure fluctuations are a major source of interference for infrasound sensors. Infrasense uses a spatial-averaging manifold with multiple inlet ports to reduce turbulent wind noise while preserving the coherent infrasound signal.
