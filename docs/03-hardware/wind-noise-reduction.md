...
| Parameter | Effect | Typical Range (IMS-scale) | Prototype Scale |
|---|---|---|---|
| Array diameter (aperture) | Larger = better low-frequency noise reduction | 18–70 m | 1–5 m |
| Number of inlets | More = better noise reduction | 96–144 | 4–12 |
| Tube diameter | Affects acoustic response | 25–50 mm | 5–15 mm |
| Tube length (total) | Affects resonances | Up to hundreds of metres | 1–5 m per arm |

> **Important:** Professional IMS stations use arrays spanning 18 to 70 metres with nearly 100 inlet ports. A prototype-scale manifold (1–5 metres) will provide some noise reduction but significantly less than a professional system. This is an expected limitation.
