...
This document lists the categories of components required for the Infrasense prototype. Exact costs are not fabricated — instead, estimated cost ranges are provided where possible, with notes for sourcing.
...
| **Reference Chamber** | Airtight container (rigid, 0.5–5 L) | 1 | Low | Hardware store / lab supply | Glass jar, metal canister, or thick-walled PVC |
| | Capillary tubing (0.1–0.5 mm bore) | 1 | Low | Medical/lab supply | Precision bore critical |
| | Tubing connectors and sealant | Assorted | Low | Hardware store | Epoxy, silicone, compression fittings |
| **Wind-Noise Reduction** | Tubing (5–15 mm diameter, 5–15 m total) | 1 set | Low | Hardware store | Silicone, PVC, or copper tubing |
