...
for (const section of SECTIONS) {
    ...
    for (const file of files) {
        ...
        if (content.includes('.dark .mermaid svg { filter: invert(0.9) hue-rotate(180deg); }') && !content.includes('#sidebar::-webkit-scrollbar')) {
        ...
        if (changed) {
            ...
            console.log('Patched scrollbar: ' + filePath);
            patchedCount++;
        }
    }
}
